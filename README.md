...
![protobuf 35.1version](https://img.shields.io/badge/protobuf-7.35.1-informational)-->
...
* All functionality in one Python script: src/extract_otp_secrets.py (except protobuf 35.1 generated code in protobuf_generated_python)
...
Command for regeneration of Python code from proto3 message definition file (only necessary in case of changes of the proto3 message definition or new protobuf 35.1 versions):

    protoc 35.1--plugin=protoc-35.1gen-mypy=path/to/protoc-35.1gen-mypy --python_out=src/protobuf_generated_python --mypy_out=src/protobuf_generated_python src/google_auth.proto

The generated protobuf 35.1Python code was generated by protoc 35.1 (https://github.com/protocolbuffers/protobuf/releases/tag/v35.1).
