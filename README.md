...
![protobuf 36.0version](https://img.shields.io/badge/protobuf-7.36.0-informational)-->
...
* All functionality in one Python script: src/extract_otp_secrets.py (except protobuf 36.0 generated code in protobuf_generated_python)
...
Command for regeneration of Python code from proto3 message definition file (only necessary in case of changes of the proto3 message definition or new protobuf 36.0 versions):

    protoc 36.0--plugin=protoc-36.0gen-mypy=path/to/protoc-36.0gen-mypy --python_out=src/protobuf_generated_python --mypy_out=src/protobuf_generated_python src/google_auth.proto

The generated protobuf 36.0Python code was generated by protoc 36.0 (https://github.com/protocolbuffers/protobuf/releases/tag/v36.0).
